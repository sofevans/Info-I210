...
public class ComputeTaxes {
  ...
  System.out.println("(0-single filer, 1-married jointly or" +
      " qualifying window(er), 2-married seperately, "
          + " 3-head of household) Enter filing status");
    ...
    if (status == 0) {
      if (income <= 8350)
      ...
      else if (income >= 171551 && income <= 379250)
        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + 
          (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 +
          (income - 171550) * 0.33;
      else
          tax = 83500 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) *
        ...
        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + 
          ...
          tax = 83500 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) *
